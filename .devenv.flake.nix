{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/bsiag.local/kli/dev/workspaces/linux/yeet";
  project_input_ref = "path:/home/bsiag.local/kli/dev/workspaces/linux/yeet";
  devenv_dotfile = "/home/bsiag.local/kli/dev/workspaces/linux/yeet/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1252231665";
  devenv_runtime = "/run/user/1252231665/devenv-f79442c";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "BSIM4329.bsiag.local";
  username = "kli@bsiag.local";
  git_root = "/home/bsiag.local/kli/dev/workspaces/linux/yeet";
  secretspec = null;
};
    in
    {
